...
const T = {
ru:{
  nav_aud:'Для кого',nav_svc:'Услуги',nav_ev:'Мероприятия',nav_pub:'Публикации',nav_fund:'База доноров',nav_price:'Тарифы',nav_con:'Связаться',
...
kg:{
  nav_aud:'Кимдер үчүн',nav_svc:'Кызматтар',nav_ev:'Иш-чаралар',nav_pub:'Жарыялоолор',nav_fund:'Донорлор базасы',nav_price:'Тарифтер',nav_con:'Байланыш',
...
en:{
  nav_aud:"Who it's for",nav_svc:'Services',nav_ev:'Events',nav_pub:'Publications',nav_fund:'Donor Database',nav_price:'Pricing',nav_con:'Contact',
...
function setLang(l){
  ...
  // Заголовок вкладки не трогаем: у каждой страницы свой <title> в HTML (главная — «База
  // доноров… fundan.cc»). Раньше здесь всем страницам ставилось «Азат Исраилов — Консультант…»,
  // и это видели поисковики и вкладка браузера.
}
